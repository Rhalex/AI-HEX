...
public class AI {
	...
	public AI()
	{
		...
		//handler = new DesktopHandler(new DLV2DesktopService("src/dlv2"));
		...
		try {
			...
			ASPMapper.getInstance().registerClass(DisturbingHex.class);
	...
	public void newFacts(DisturbingHex h) throws Exception
	{
		facts.addObjectInput(new DisturbingHex(h));
	}
